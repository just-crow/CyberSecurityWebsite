...
export default function Home() {
  return (
    ...
    <h1 className="info-text">Weak passwords cause the most damage in the community. Many people use predictable and commonly used passwords such as <code>“1234567”</code>, <code>“querty”</code>... Nowadays, computers can break through these passwords in a matter of minutes. Damages caused by weak passwords can be huge. Hackers can infiltrate into your accounts, enabling them to steal your identity, take over your websites, damage your reputation, breach data, etc.</h1>
