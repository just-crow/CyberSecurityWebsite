...
export default function Navbar() {
    return (
        <NBContainer cs="text-white w-full h-25 flex justify-around items-center bg-linear-to-b from-[#19c90b]/30 fixed top-0 hover:from-[#19c90b]/50 transition-colors duration-300 z-50 pb-5 text-[12px] sm:text-[1.3vw]">
